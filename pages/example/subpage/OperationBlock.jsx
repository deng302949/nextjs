    ...
    <div>
      <div className={`clearfix operation`}>
        ...
        <Button
          ...
          className={`left btn-batch`}
        >
          批量删除
        </Button>
        <Dropdown overlay={state.menu} overlayClassName={'dropdown-menu'}>
          <Button shape="round"  className={'dropdown'}>
            更多操作
            <Icon type="down" />
          </Button>
        </Dropdown>
      ...
      <div className={'statistics'}>
        <i className={`iconfont iconyonghu-bangzhu bangzhu`}></i>
        已选择<span className={'select-num'}>{store.selectList.length}</span>项
